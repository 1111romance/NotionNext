...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blogutopia.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客文章', // 网站关键词 英文逗号隔开
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/1111romance', // 你的github个人主页 例如 https://github.com/tangly1024
